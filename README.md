...
2. 点击蓝字安装 [插件](https://raw.githubusercontent.com/realMrHu/websource-view/main/WebSource-View.js)
  
3. 完成安装，建议阅读以下内容

## ❤️使用教程
单击页面右下角(初始位置)显示放大镜的图标即可在新标签页面查看源码。

单击源码页面右上角的下载图标即可下载Html文件。长按源码进行复制。

长按并拖动显示放大镜的图标即可移动图标位置。
